...
public:
  ...
  subscribeStereoCamera( image_transport::ImageTransport & image_it,
    ...
    return StereoCameraSubscriber(image_it, info_nh, base_topic_left, base_topic_right, 
                                  queue_size, callback, tracked_object, transport_hints);
  }
  ...
  subscribeStereoCamera( image_transport::ImageTransport & image_it,
    ...
    return subscribeStereoCamera( image_it, info_nh, 
                                  ...
                                  Callback(fp), ros::VoidPtr(), transport_hints );
  }
  ...
  subscribeStereoCamera( image_transport::ImageTransport & image_it,
    ...
    return subscribeStereoCamera( image_it, info_nh, 
                                  base_topic_left, base_topic_right, queue_size,
                                  boost::bind(fp, obj, _1, _2, _3, _4), ros::VoidPtr(), 
                                  transport_hints );
  }
  ...
  subscribeStereoCamera( image_transport::ImageTransport & image_it,
    ...
    return subscribeStereoCamera( image_it, info_nh, 
                                  base_topic_left, base_topic_right, queue_size,
                                  boost::bind(fp, obj.get(), _1, _2, _3, _4), obj, 
                                  transport_hints );
  }
